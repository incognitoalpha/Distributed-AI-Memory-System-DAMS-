...
public class TenantRlsAspect {
    ...
    public void setTenantContext() {
        if (TenantContext.isSet()) {
            ...
            log.trace("Setting RLS tenant context for transaction: tenantId={}", tenantId);
            ...
            log.warn("Executing repository method without tenant context! This may fail if RLS is forced on the table.");
        }
    }
}
